...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- script for marrion's data based on the script for e-rara images -->
...
<!-- setup for the footer -->
            ...
            <xsl:for-each select="pb">
                ...
                <xsl:element name="div">
                    ...
                    <xsl:element name="div">
                        ...
                        <xsl:element name="img">
                            <xsl:attribute name="src">
                                <xsl:value-of select="concat('../../../Web_interface/IMG/FRCAOM06_COLE/', substring-after(@corresp, 'f'), '.jpg')"/>
                            </xsl:attribute>
    ...
    <xsl:template match="ab">
        ...
        <xsl:choose>
        <!-- modificatition pour le script de marion  -->
            <xsl:when test="@type='TitlePageZone'">
                <xsl:element name="span">
                    <xsl:attribute name="class">
                        <xsl:text>ab_Drop</xsl:text> <!-- je reprends la css de la Dropcapital -->
                    </xsl:attribute>
                    <xsl:apply-templates/>
                </xsl:element>
            </xsl:when>
